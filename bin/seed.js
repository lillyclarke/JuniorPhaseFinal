...
const seed = async () => {
  ...
  const campus1 = await Campus.create({name: 'Campus 1', imageUrl: 'https://www.fillmurray.com/300/300', description: 'This is campus 1'});
  const campus2 = await Campus.create({name: 'Campus 2', imageUrl: 'https://www.fillmurray.com/300/300', description: 'This is campus 2'});
  const campus3 = await Campus.create({name: 'Campus 3', imageUrl: 'https://www.fillmurray.com/300/300', description: 'This is campus 3'});
  ...
  module.export = {seed, db, models:{ Student, Campus }};
